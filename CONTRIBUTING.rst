...
Welcome to ``wai_data_tools`` contributor's guide.
...
If you experience bugs or general issues with ``wai_data_tools``, please have a look
...
You can help improve ``wai_data_tools`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``wai_data_tools`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``wai_data_tools``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n wai_data_tools python=3 six virtualenv pytest pytest-cov
    conda activate wai_data_tools
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/wai_data_tools.git
    cd wai_data_tools
...
#. Install |pre-commit|_::
   ...
   ``wai_data_tools`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/wai_data_tools
.. _issue tracker: https://github.com/<USERNAME>/wai_data_tools/issues
.. <-- end -->
