...
def manually_reclassify_frames(src_root_dir: pathlib.Path,
    ...
    :param src_root_dir: Path to the source root directory to read frame images
    :param dst_root_dir: Path to the destination root directory to save reclassified frame images
